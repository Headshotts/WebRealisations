        ...
        if(isset($_SESSION['nom']) && isset($_SESSION['prenom']) && isset($_SESSION['handicap'])){
           if(isset($_POST['btnSubmit'])){
               ...
               if($date_reserv < $current_date){
                   ...
                   //Modifie les places restantes de la destination dans la BDD.
...
<body>
  ...
  <main>
      ...
      <?php endif;?>
      <p id="info_reserv">Vous souhaitez réserver pour le voyage : <?=$resultat_d->nom?></p>
      <form id="form-reserv" method="POST" action="reservations.php?id_destination=<?=$_GET['id_destination']?>">
        <fieldset>
            <p>
